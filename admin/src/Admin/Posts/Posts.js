...
function Posts() {
  ...
  const fetchPosts = async () => {
    try {
      const response = await axios.get("https://amongusdashboard.craftifyproductions.com/api/posts/new-all-post"); // Updated URL
  ...
  const handleDelete = async (postId) => {
    try {
      await axios.delete(`https://amongusdashboard.craftifyproductions.com/api/posts/${postId}`);
 ...
 const onDragEnd = async (result) => {
  ...
  try {
    await axios.post("https://amongusdashboard.craftifyproductions.com/api/order/update", {
