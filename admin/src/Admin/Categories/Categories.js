...
//       html:
//         '<input id="categoryName" className="swal2-input" placeholder="Category Name">' +
//         '<input id="categoryDescription" className="swal2-input" placeholder="Category Description">',
...
//           <p><b>Category Name</b>: <input id="swal-input1" className="swal2-input" value="${category.name}"></p>
//           <p><b>Category Description</b>: <textarea id="swal-input2" className="swal2-textarea">${category.description}</textarea></p>
//         </div>
//       `,
//       showCancelButton: true,
//       confirmButtonText: 'Confirm',
...
//           <FontAwesomeIcon
//             className="text-red-500 cursor-pointer hover:text-indigo-700"
//             icon={faTrash}
//           />
//         </td>
